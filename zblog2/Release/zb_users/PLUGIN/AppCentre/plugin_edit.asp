...
If Request.Form.Count>0 Then
  ...
  Response.Redirect "plugin_edit.asp?id="&Request.Form("app_id")
          ...
          <div id="divMain2">
            <form method="post" action="">
              <table border="1" width="100%" cellspacing="0" cellpadding="0" class="tableBorder tableBorder-thcenter">
                ...
                <tr>
                  <td><p><b>· 插件ID</b><br/>
                      <span class="note">&nbsp;&nbsp;插件ID为插件的目录名,且不能重复.</span></p></td>
                  <td><p>&nbsp;
                ...
                <tr>
                  <td><p><b>· 插件简介</b></p></td>
                  <td><p>&nbsp;
                      <input id="app_note" name="app_note" style="width:550px;"  type="text" value="<%=TransferHTML(TransferHTML(app_note,"[textarea]"),"[""]")%>" />
                    </p></td>
                </tr>
                <tr>
...
<%=CreateOptoinsOfVersion(app_adapted)%>
                ...
                <tr>
                  <td><p><b>· 【高级】重写系统函数列表（以|分隔）</b>(可选)</p></td>
                  <td><p>&nbsp;
              ...
              <p><br/>
                ...
                <input type="submit" class="button" value="发布到应用中心" id="btnPost" onclick="window.location='submit.asp?type=plugin&id=<%=ID%>';return false;" /><% End If %>
              </p>
              <p>&nbsp;</p>
            </form>
          </div>
