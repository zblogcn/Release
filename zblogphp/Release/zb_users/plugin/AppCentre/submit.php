...
<table class="tableFull tableBorder tableBorder-thcenter">
<tr><td class="td30"><p><b>· <?php echo $zbp->lang['AppCentre']['tfa_verification']; ?></b></p></td><td><p>&nbsp;<input id="tfa_verification" name="tfa_verification" style="width:550px;" autocomplete="off" type="text" value="" placeholder="<?php echo $zbp->lang['AppCentre']['tfa_verification_placeholder']; ?>" /></p></td></tr>
</table>
