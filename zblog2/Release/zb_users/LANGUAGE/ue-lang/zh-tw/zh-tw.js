...
UE.I18N['zh-tw'] = {
    'labelMap':{
        ...
        'mergecells':'合併多個單元格', 'deletetable':'刪除表格', 'cleardoc':'清空文件','insertparagraphbeforetable':"表格前插入行",'insertcode':'程式碼語言','fontfamily':'字型', 'fontsize':'字號', 'paragraph':'段落格式', 'insertimage':'圖片',
        'edittable':'表格屬性','edittd':'單元格屬性', 'link':'連結','emotion':'表情', 'spechars':'特殊字元', 'searchreplace':'查詢替換', 'map':'Baidu地圖', 'gmap':'Google地圖',
    ...
    'insertimage':{
        'static':{
            lang_tab_remote:"遠端圖片", //節點
            lang_tab_local:"本地上傳",
            lang_tab_imgManager:"線上管理",
            lang_tab_imgSearch:"圖片搜尋",
            lang_input_url:"地 址：",
            ...
            'imgType':{title:"圖片類型", options:["新聞", "桌布", "表情", "頭像"]}, //select的option
            'imgSearchTxt':{value:"請輸入搜尋關鍵詞"},
            'imgSearchBtn':{value:"百度一下"},
            'imgSearchReset':{value:"清空搜尋"},
            'upload':{style:'background: url(upload.png);'},
            'duiqi':{style:'background: url(imglabel.png) -12px 2px no-repeat;'},
            'lang_savePath':'選擇儲存目錄：',
            'lang_load_savePath': '正在讀取目錄...'
        },
        'netError':"網路連結錯誤，請檢查配置後重試！",
        'noUploadImage':"當前未上傳過任何圖片！",
        'imageLoading':"圖片載入中，請稍後……",
        'tryAgain':" :( ，抱歉，沒有找到圖片！請重試一次！",
        'toggleSelect':"單擊可切換選中狀態\n原圖尺寸: ",
        'searchInitInfo':"請輸入搜尋關鍵詞",
    ...
    'music':{
        'static':{
            ...
            'lang_tab_remote':"百度搜尋",
            'lang_tab_local':"網路歌曲"
        },
        'emptyTxt':'未搜尋到相關音樂結果，請換一個關鍵詞試試。',
        'chapter':'歌曲',
        'singer':'歌手',
        'special':'專輯',
        'listenTest':'試聽'
    ...
    'gmap':{
        'static':{
            'lang_input_address':'位址',
            'lang_input_search':'搜尋',
            'address':{value:"北京"}
        },
        searchError:'無法定位到該位址!'
    },
    'help':{
        'static':{
    ...
    'link':{
        ...
        'httpPrompt':'您輸入的連結中不包含http等協議名稱，默認將為您添加http://字首'
    },
    'map':{
        'static':{
            lang_city:"城市",
    ...
    'wordimage':{
        'static':{
            ...
            lang_step:"1、點選頂部複製按鈕，將位址複製到剪貼簿；2、點選添加照片按鈕，在彈出的對話方塊中使用Ctrl+V貼上位址；3、點選開啟後選擇圖片上傳流程。"
        },
        'fileType':"圖片",
