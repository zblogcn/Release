    ...
    ?>
        &nbsp;(
            ...
            <p>
                ...
                <br />
                <input id="edtName" class="edit" size="40" name="Name" maxlength="<?php echo $zbp->option['ZC_USERNAME_MAX']; ?>" type="text" value="<?php echo $member->Name; ?>" <?php if (!$zbp->CheckRights('MemberAll')) {
