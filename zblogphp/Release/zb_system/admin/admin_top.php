...
<header class="header">
    <div class="logo"><?php if(CheckIsMoblie()) { ?><a href="<?php echo $zbp->cmdurl . '?act=admin'; ?>" title="<?php ?>"><?php } else {?><a href="<?php echo $bloghost; ?>" title="<?php echo htmlspecialchars($blogname); ?>" target="_blank"><?php }?><img src="<?php echo $bloghost; ?>zb_system/image/admin/none.gif" alt="Z-Blog"/></a></div>
